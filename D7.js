...
function concatenaStringhe(stringa1, stringa2) {
  const primiDue = stringa1.substring(0, 2)

  const ultimiTre = stringa2.substring(stringa2.length - 3)
...
const arrayDiNumeriCasuali = generaArrayRandom()
console.log(arrayDiNumeriCasuali)
...
const risultatoLunghezze = lunghezzeStringhe(arrayDiStringhe)

console.log(risultatoLunghezze)
...
const risultatiDispari = creaArrayDispari()
console.log(risultatiDispari)
